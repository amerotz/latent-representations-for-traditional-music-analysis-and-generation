...
def main(args):
    ...
    title = f'folkbar-VAE {args.latent_size}/{args.hidden_size} learned latent space'
    ...
    plt.savefig(
        f'bars_no_cc/plots/folkbar-VAE_{args.latent_size}-{args.hidden_size}_{args.type}_{args.seed}.png',
        dpi=200
    )
