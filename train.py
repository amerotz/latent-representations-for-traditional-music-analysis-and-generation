...
def main(args):
    ...
    params = dict(
        ...
        conditioned=args.conditioned,
        cond_size=datasets['train'].cond_vocab_size
    )
    ...
    def loss_fn(logp, target, length, mean, logv, anneal_function, step, k, x0, KL_W=None):
    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                ...
                # Forward pass
                logp, mean, logv, z, z_cond = model(batch['input'],
                                            batch['length'],
                                            cond)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-kl', '--kl_weight', type=float, default=None)
